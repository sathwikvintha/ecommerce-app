...
const Checkout = () => {
  ...
  const checkOutHandler = async () => {
    ...
    const options = {
      key: "rzp_test_0zdEWhxgcWvm4B", // Enter the Key ID generated from the Dashboard
      amount: amount,
      currency: currency,
      name: "Fashion Sathwik",
      ...
      prefill: {
        name: "Sathwik Vintha",
        email: "sathwikvintha2004@example.com",
        contact: "9342566756",
      },
      notes: {
          ...
          <div className="col-7">
            <div className="checkout-left-data">
              ...
              <p className="user-details total">
                Sathwik Vintha (sathwikvintha2004@gmail.com)
              </p>
              ...
              >
                ...
                <div className="w-100">
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    <Link to="/cart" className="buttonforshipping">
                      Continue Shipping
                    </Link>
                    <button className="buttonforshipping" type="submit">
                      Place Order
                    </button>
                  </div>
                </div>
