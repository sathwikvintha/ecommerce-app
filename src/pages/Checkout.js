          ...
          <div className="col-5">
            <div className="border-bottom py-4">
              <div className="d-flex gap-10 align-items-center">
                <div className="w-75 mb-2 d-flex gap-10">
                  ...
                  <div>
                    <h5 className="total-price">dkdfkjdf</h5>
                    <p className="total-price">s fjgn dfjng</p>
                  </div>
                </div>

                <div className="flex-grow-1">
                  <h5 className="total">₹ 599</h5>
                </div>
              </div>
              <div className="d-flex gap-10 align-items-center">
                <div className="w-75 mb-2 d-flex gap-10">
            ...
            <div className="border-bottom py-4">
              <div className="d-flex justify-content-between align-items-center">
                ...
                <p className="total-price">₹ 1,498</p>
              </div>
              <div className="d-flex justify-content-between align-items-center">
            ...
            <div className="d-flex justify-content-between align-items-center border-bottom py-4">
              ...
              <h5 className="total-price">₹ 1,598</h5>
            </div>
          </div>
        </div>
      </Container>
